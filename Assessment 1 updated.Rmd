...
fastfood$total_fat <- as.factor(fastfood$total_fat)
skim(fastfood)

fastfood$cal_fat <- as.factor(fastfood$cal_fat)
skim(fastfood)

fastfood$calories <- as.integer(fastfood$calories)
...
fastfood %>% count(calories)

#19.Create two new variables.

table(group=cut_number(fastfood$calories,3)) 
